    ...
    internal class ReflectionWorker
    {
        ...
        private static bool HasMemberAttribute(MemberInfo memberInfo, Type type)
        {
            ...
            return attributeDatas.Any(attributeData =>
                attributeData.Constructor.DeclaringType != null && attributeData.Constructor.DeclaringType.FullName == type.FullName);
        }
        ...
        private static NRTypeUsage GetTypeUsage(Type type, IEnumerable<CustomAttributeData> customAttributeDatas, Type declaringType)
        {
            CustomAttributeData dynamicAttributeData = customAttributeDatas.FirstOrDefault(ad =>
                ad.Constructor != null && ad.Constructor.DeclaringType != null && ad.Constructor.DeclaringType.FullName != null &&
        ...
        private IEnumerable<NRAttribute> GetAttributes(IEnumerable<CustomAttributeData> attributeDatas)
        {
            ...
            foreach (CustomAttributeData attributeData in attributeDatas)
            {
                ...
                if (attributeType != null && (attributeType == typeof(DynamicAttribute) || attributeType == typeof(ExtensionAttribute) ||
                                              attributeType == typeof(OutAttribute) || attributeType == typeof(ParamArrayAttribute) ||
